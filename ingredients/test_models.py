...
class IngredientTestCase(TestCase):
    ...
    def test_str_representation(self):
        """
        Test to ensure that a string representation of an ingredient is
        correct
        """
    ...
    def test_slug(self):
        """ Test to ensure that a slug is properly created """

        self.assertEqual(slugify(self.ingredient2.name), self.ingredient2.slug)

    def test_absolute_url(self):
        """ Test to ensure that an absolute path leads to a correct view """
...
class UnitsTestCase(TestCase):
    ...
    def test_str_representation(self):
        """ Test to ensure that a string representation of unit is correct """
